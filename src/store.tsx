...
const seedLines: PurchaseLine[] = [
  { id: "P19", cdnSn: "CDN202608200051", orderSn: "LGCX202608200030", stShipSn: "Y260820KT0051", lineNo: 1, productName: "三菱空调机_FDTC32KXE6F", productCode: "A01836532", model: "FDTC32KXE6F", qty: 2, policyAmount: 4360, supplier: SUHAO, supplierKind: "suhao", salesCompany: BJ, purchaseType: "随单采", salesShipSn: "DF202608200051", customer: "太原通达机电设备有限公司", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P20", cdnSn: "CDN202608200051", orderSn: "LGCX202608200030", stShipSn: "Y260820KT0051", lineNo: 2, productName: "无线遥控器_PAR-31MAA-RC", productCode: "A01290110", model: "PAR-31MAA-RC", qty: 2, policyAmount: 480, supplier: SUHAO, supplierKind: "suhao", salesCompany: BJ, purchaseType: "随单采", salesShipSn: "DF202608200051", customer: "太原通达机电设备有限公司", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P1", cdnSn: "CDN202608190039", orderSn: "LGCX202608190020", stShipSn: "Y260819KT0024", lineNo: 1, productName: "三菱空调机_FDC224KXMEN1Q", productCode: "A01835555", model: "FDC224KXMEN1Q", qty: 1, policyAmount: 15300, supplier: SUHAO, supplierKind: "suhao", salesCompany: BJ, purchaseType: "随单采", salesShipSn: "DF202608190107", customer: "山西舒安盛建设工程有限公司", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P2", cdnSn: "CDN202608190039", orderSn: "LGCX202608190020", stShipSn: "Y260819KT0024", lineNo: 2, productName: "三菱空调机_FDUCV18KXME1Q-D", productCode: "A01835616", model: "FDUCV18KXME1Q-D", qty: 2, policyAmount: 3960, supplier: SUHAO, supplierKind: "suhao", salesCompany: BJ, purchaseType: "随单采", salesShipSn: "DF202608190107", customer: "山西舒安盛建设工程有限公司", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P3", cdnSn: "CDN202608190039", orderSn: "LGCX202608190020", stShipSn: "Y260819KT0024", lineNo: 3, productName: "有线遥控器_RC-MBD2", productCode: "A01290064", model: "RC-MBD2", qty: 6, policyAmount: 1113, supplier: SUHAO, supplierKind: "suhao", salesCompany: BJ, purchaseType: "随单采", salesShipSn: "DF202608190107", customer: "山西舒安盛建设工程有限公司", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P4", cdnSn: "CDN202608180012", orderSn: "LGCX202608180008", stShipSn: "Y260818MH0011", supplierOrderNo: "SO-260818-011-Q", lineNo: 1, productName: "空调室内机_FDTC50KXE6F", productCode: "A01836150", model: "FDTC50KXE6F", qty: 1, policyAmount: 2680, supplier: MHI, supplierKind: "mitsubishi", salesCompany: CD, purchaseType: "直采", matchStatus: "matched", invoiceId: "INV-B", invoiceNo: "26952000003459565756", invoiceLineId: "B1", invoiceAmount: 2300.88, taxAmount: 299.12, totalAmount: 2600, feeAmount: 0, poPushStatus: "none", apPushStatus: "none" },
  { id: "P5", cdnSn: "CDN202608180012", orderSn: "LGCX202608180008", stShipSn: "Y260818MH0011", supplierOrderNo: "SO-260818-011-Q", lineNo: 2, productName: "过滤器", productCode: "A01837011", model: "FLT-01", qty: 4, policyAmount: 320, supplier: MHI, supplierKind: "mitsubishi", salesCompany: CD, purchaseType: "直采", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P6", cdnSn: "CDN202608180013", orderSn: "LGCX202608180009", stShipSn: "Y260818MH0012", supplierOrderNo: "SO-260818-012-Q", lineNo: 1, productName: "空调室内机_FDTC60KXE6F", productCode: "A01836160", model: "FDTC60KXE6F", qty: 1, policyAmount: 2100, supplier: MHI, supplierKind: "mitsubishi", salesCompany: CD, purchaseType: "直采", matchStatus: "matched", invoiceId: "INV-B", invoiceNo: "26952000003459565756", invoiceLineId: "B2", invoiceAmount: 1782.3, taxAmount: 231.7, totalAmount: 2014, feeAmount: 50, poPushStatus: "none", apPushStatus: "none" },
  { id: "P7", cdnSn: "CDN202608180013", orderSn: "LGCX202608180009", stShipSn: "Y260818MH0012", supplierOrderNo: "SO-260818-012-Q", lineNo: 2, productName: "铜管配件", productCode: "A01837012", model: "CU-PIPE", qty: 10, policyAmount: 500, supplier: MHI, supplierKind: "mitsubishi", salesCompany: CD, purchaseType: "直采", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P8", cdnSn: "CDN202608170001", orderSn: "LGCX202608170002", stShipSn: "ST170002", lineNo: 1, productName: "维修服务", productCode: "A01901001", model: "SVC-01", qty: 1, policyAmount: 2400, supplier: OTHER, supplierKind: "other", salesCompany: SZ, purchaseType: "直采", matchStatus: "matched", invoiceId: "INV-C", invoiceNo: "25372000001122334455", invoiceLineId: "C1", invoiceAmount: 2000, taxAmount: 260, totalAmount: 2260, feeAmount: 0, poPushStatus: "none", apPushStatus: "none" },
  { id: "P9", cdnSn: "CDN202608170001", orderSn: "LGCX202608170002", stShipSn: "ST170002", lineNo: 2, productName: "配件_PART-X", productCode: "A01901002", model: "PART-X", qty: 2, policyAmount: 1200, supplier: OTHER, supplierKind: "other", salesCompany: SZ, purchaseType: "直采", matchStatus: "matched", invoiceId: "INV-D", invoiceNo: "25372000001122339900", invoiceLineId: "D1", invoiceAmount: 1000, taxAmount: 130, totalAmount: 1130, feeAmount: 0, poPushStatus: "none", apPushStatus: "none" },
  { id: "P10", cdnSn: "CDN202608100044", orderSn: "LGCX202608100010", stShipSn: "Y260810AA0001", lineNo: 1, productName: "全热交换器_SAFHD350BQ", productCode: "A01855991", model: "SAFHD350BQ", qty: 1, policyAmount: 4095, supplier: SUHAO, supplierKind: "suhao", salesCompany: BJ, purchaseType: "随单采", salesShipSn: "DF202608100022", customer: "山西舒安盛建设工程有限公司", matchStatus: "matched", invoiceId: "INV-E", invoiceNo: "26992000000011112222", invoiceLineId: "E1", invoiceAmount: 3628.32, taxAmount: 471.68, totalAmount: 4100, feeAmount: 0, poPushStatus: "none", apPushStatus: "none" },
  { id: "P11", cdnSn: "CDN202608160008", orderSn: "LGCX202608160003", stShipSn: "Y260816KT0008", supplierOrderNo: "SO-260816-003-Q", lineNo: 1, productName: "室外机_FDC140", productCode: "A01835140", model: "FDC140KXEN6F", qty: 1, policyAmount: 3100, supplier: MHI, supplierKind: "mitsubishi", salesCompany: BJ, purchaseType: "直采", matchStatus: "unmatched", kingdeePoNo: "KDCG2608160003", poPushStatus: "unsent", apPushStatus: "none" },
  { id: "P12", cdnSn: "CDN202608160008", orderSn: "LGCX202608160003", stShipSn: "Y260816KT0008", supplierOrderNo: "SO-260816-003-Q", lineNo: 2, productName: "室内机_FDUM71", productCode: "A01835071", model: "FDUM71KXE6F", qty: 1, policyAmount: 2050, supplier: MHI, supplierKind: "mitsubishi", salesCompany: BJ, purchaseType: "直采", matchStatus: "unmatched", kingdeePoNo: "KDCG2608160003", poPushStatus: "unsent", apPushStatus: "none" },
  { id: "P13", cdnSn: "CDN202608150005", orderSn: "LGCX202608150001", stShipSn: "MIX150005", lineNo: 1, productName: "维修服务", productCode: "A01901001", model: "SVC-01", qty: 1, policyAmount: 2400, supplier: OTHER, supplierKind: "other", salesCompany: SZ, purchaseType: "直采", matchStatus: "matched", invoiceId: "INV-C", invoiceNo: "25372000001122334455",     invoiceLineId: "C1-hist", invoiceAmount: 2000, taxAmount: 260, totalAmount: 2260, feeAmount: 0, kingdeePoNo: "KDCG2608150001", poPushStatus: "success", apPushStatus: "exception" },
  { id: "P14", cdnSn: "CDN202608150006", orderSn: "LGCX202608150002", stShipSn: "MIX150006", lineNo: 1, productName: "配件_PART-X", productCode: "A01901002", model: "PART-X", qty: 2, policyAmount: 1200, supplier: OTHER, supplierKind: "other", salesCompany: SZ, purchaseType: "直采", matchStatus: "matched", invoiceId: "INV-D", invoiceNo: "25372000001122339900", invoiceLineId: "D1-hist", invoiceAmount: 1000, taxAmount: 130, totalAmount: 1130, feeAmount: 0, kingdeePoNo: "KDCG2608150001", poPushStatus: "success", apPushStatus: "exception" },
  { id: "P15", cdnSn: "CDN202608140001", orderSn: "LGCX202608140001", stShipSn: "Y260814MH0001", supplierOrderNo: "SO-260814-021-Q", lineNo: 1, productName: "空调室内机_FDTC40KXE6F", productCode: "A01836140", model: "FDTC40KXE6F", qty: 1, policyAmount: 2200, supplier: MHI, supplierKind: "mitsubishi", salesCompany: CD, purchaseType: "直采", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P16", cdnSn: "CDN202608140002", orderSn: "LGCX202608140002", stShipSn: "Y260814MH0002", supplierOrderNo: "SO-260814-022-Q", lineNo: 1, productName: "空调室内机_FDTC71KXE6F", productCode: "A01836171", model: "FDTC71KXE6F", qty: 1, policyAmount: 2050, supplier: MHI, supplierKind: "mitsubishi", salesCompany: CD, purchaseType: "直采", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
  { id: "P17", cdnSn: "CDN202608130001", orderSn: "LGCX202608130001", stShipSn: "Y260813MH0008", supplierOrderNo: "SO-260813-008-Q", lineNo: 1, productName: "室外机_FDC100", productCode: "A01835100", model: "FDC100KXEN6F", qty: 1, policyAmount: 2900, supplier: MHI, supplierKind: "mitsubishi", salesCompany: BJ, purchaseType: "直采", matchStatus: "unmatched", poPushStatus: "none", apPushStatus: "none" },
...
function assignPoAndPush(
  lines: PurchaseLine[],
  groupIds: string[],
  existing: string[],
): { lines: PurchaseLine[]; existing: string[]; poNo: string; skipped: boolean } {
  const group = lines.filter((l) => groupIds.includes(l.id));
  if (!group.length) return { lines, existing, poNo: "", skipped: true };
  const pending = group.filter((l) => l.poPushStatus !== "success");
  if (!pending.length) {
    return { lines, existing, poNo: group.find((l) => l.kingdeePoNo)?.kingdeePoNo || "", skipped: true };
  }
  const pendingNos = [...new Set(pending.map((l) => l.kingdeePoNo).filter(Boolean))] as string[];
  let poNo: string;
  if (pendingNos.length === 1) {
    poNo = pendingNos[0];
  } else {
    poNo = nextKingdeePoNo([...existing, ...lines.map((l) => l.kingdeePoNo || "")]);
    existing = [...existing, poNo];
  }
  const idSet = new Set(pending.map((l) => l.id));
  return {
    lines: lines.map((l) =>
      idSet.has(l.id) ? { ...l, kingdeePoNo: poNo, poPushStatus: "success" as PoPushStatus } : l,
    ),
    existing,
    poNo,
    skipped: false,
...
function reducer(state: State, action: Action): State {
  switch (action.type) {
    ...
    case "match": {
      ...
      const candidates = targets.filter((l) => l.matchStatus === "unmatched");
      const first = candidates[0];
      const sos = parseSoNos(inv.memo);
      const y2Hit =
        inv.supplierKind === "suhao" && candidates.some((l) => l.stShipSn && inv.memo.includes(l.stShipSn));
      const soHit =
        inv.supplierKind === "mitsubishi" &&
        sos.length > 0 &&
        candidates.some((l) => l.supplierOrderNo && sos.includes(l.supplierOrderNo.toUpperCase()));
      const buyerSellerHit =
        inv.supplierKind === "other" &&
        !!first &&
        inv.buyer === first.salesCompany &&
        inv.seller === first.supplier;
      const pairs = pairByModelQty(candidates, unused);
      ...
      const prefix = y2Hit ? "Y2路径" : soHit ? `SO路径（${sos.join("、")}）` : buyerSellerHit ? "购销方路径" : "人工匹配";
      const selected = lines.filter((l) => l.invoiceId === inv.id).map((l) => l.id);
      return toast(
        { ...state, lines, invoices, selected },
        leftoverInv
          ? `${prefix}已匹配 ${n} 行，发票仍有 ${leftoverInv} 行未占用（部分匹配）`
          : `${prefix}已匹配 ${n} 行${cdns.length > 1 ? `，跨 ${cdns.length} 张采购送货单` : ""}，金额/费用已回写`,
        leftoverInv ? "warn" : "ok",
      );
    }
    case "unbindInvoice": {
    ...
    case "pushPo": {
      const selected = state.lines.filter((l) => state.selected.includes(l.id));
      if (!selected.length) return toast(state, "请先勾选明细", "warn");
      const invoiceIds = [...new Set(selected.map((l) => l.invoiceId).filter(Boolean))] as string[];
      const unmatchedIds = selected.filter((l) => !l.invoiceId).map((l) => l.id);
      let lines = state.lines;
      let existing = [...state.poSeqExisting];
      const ok: string[] = [];
      const skip: string[] = [];
      for (const invId of invoiceIds) {
        const groupIds = lines.filter((l) => l.invoiceId === invId).map((l) => l.id);
        const result = assignPoAndPush(lines, groupIds, existing);
        lines = result.lines;
        existing = result.existing;
        if (result.skipped) {
          if (result.poNo) skip.push(result.poNo);
        } else {
          ok.push(result.poNo);
        }
      }
      if (unmatchedIds.length) {
        const result = assignPoAndPush(lines, unmatchedIds, existing);
        lines = result.lines;
        existing = result.existing;
        if (result.skipped) {
          if (result.poNo) skip.push(result.poNo);
      ...
      if (!ok.length) {
        return toast(
          { ...state, lines, poSeqExisting: existing },
          `未下推：${parts.join("；") || "没有待推送明细"}`,
          "warn",
        );
      }
      return toast(
        { ...state, lines, poSeqExisting: existing, selected: [] },
        `已按票/未配行拆分下推：${parts.join("；")}`,
        "ok",
      );
    }
    case "runApJob": {
      ...
      for (const [poNo, group] of groups) {
        ...
        const invoiceNos = [...new Set(group.map((g) => g.invoiceNo).filter(Boolean))] as string[];
        if (!allMatched) {
          skipped += 1;
        ...
        if (invoiceNos.length > 1) {
          bad += 1;
          for (const row of next) {
            if (row.kingdeePoNo === poNo) row.apPushStatus = "exception";
          }
          continue;
        }
        ok += 1;
        for (const row of next) {
          if (row.kingdeePoNo === poNo) row.apPushStatus = "success";
        }
      }
      const parts = [
        `成功 ${ok} 单`,
        skipped ? `跳过 ${skipped} 单（无发票或部分匹配不推送）` : "",
        bad ? `推送异常 ${bad} 单（同一金蝶采购订单存在多个发票号）` : "",
      ].filter(Boolean);
      return toast(
        { ...state, lines: next },
        `应付单下推金蝶完成：${parts.join("，")}`,
        bad ? "warn" : "ok",
      );
    }
    default:
